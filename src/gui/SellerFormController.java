...
public class SellerFormController implements Initializable {
	...
	//Pega os dados preenchidos no formulário e carrega em um objeto
	private Seller getFormData() {
		...
		//Converte a data escolhida no computador do usuário para instant, que é uma data independente da localidade
		 */
	...
	// Carrega o formulário com os dados do vendedor
	...
	//Testa cada um dos possíveis erros e seta o valor do label correspondente
